...
class ExpenseForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        while self.cleaned_data.get(field_name):
            ...
            if i < len(self.users):
                ...
                break
        self.cleaned_data['users-expenses'] = {"users": self.users, "percentages": percentages}
    ...
    def save(self):
        ...
        expense.save()
        for user, percentage in zip(self.cleaned_data['users-expenses']['users'], self.cleaned_data['users-expenses']['percentages']):
            Record.objects.create(
                expense=expense,
                user=user,
                percent_of_share=percentage,
            )
